    ...
    <div class="row mt-4">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <!-- Header -->
                    <h4 class="card-title text-center text-3xl font-bold">Add A Product</h4>
                    ...
                    <form class="form-horizontal p-t-20" action="{{ route('product.store') }}" method="POST"
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="number"
                                        ...
                                        required value="{{ old('regular_price') }}">
                                    <input type="number"
                                        class="form-control bg-slate-700 border border-slate-600 rounded-lg text-slate-200 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea
                                    class="form-control bg-slate-700 border border-slate-600 rounded-lg text-slate-200 focus:ring-blue-500 focus:border-blue-500"
                                    id="short_description" name="short_description" rows="2" placeholder="Enter short description">{{ old('short_description') }}</textarea>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea
                                    ...
                                    id="long_description" name="long_description" rows="5" placeholder="Enter long description">{{ old('long_description') }}</textarea>
