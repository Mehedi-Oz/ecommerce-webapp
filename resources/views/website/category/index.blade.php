                            ...
                            <div class="tab-pane fade show active" id="nav-grid" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/') }}website/images/products/product-1.jpg"
                                                    alt="#">
                                                <div class="button">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/') }}website/images/products/product-2.jpg"
                                                    alt="#">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/') }}website/images/products/product-3.jpg"
                                                    alt="#">
                                                <div class="button">
                                                    <a href="product-details.html" class="btn"><i
                                                            class="lni lni-cart"></i> Add to Cart</a>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/') }}website/images/products/product-4.jpg"
                                                    alt="#">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/') }}website/images/products/product-5.jpg"
                                                    alt="#">
                                                <div class="button">
                                                    <a href="product-details.html" class="btn"><i
                                                            class="lni lni-cart"></i> Add to Cart</a>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/') }}website/images/products/product-6.jpg"
                                                    alt="#">
                                                <div class="button">
                                                    <a href="product-details.html" class="btn"><i
                                                            class="lni lni-cart"></i> Add to Cart</a>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/') }}website/images/products/product-7.jpg"
                                                    alt="#">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{ asset('/') }}website/images/products/product-8.jpg"
                                                    alt="#">
                                                <div class="button">
                                                    <a href="product-details.html" class="btn"><i
                                                            class="lni lni-cart"></i> Add to Cart</a>
